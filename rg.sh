...
g++ -c -Wall -m64 -no-pie -l isfloat.lis -o isfloat.o isfloat.cpp -std=c++17 -g #look up c version

echo "Compile the C module maxwell.c"
g++ -c -Wall -m64 -no-pie -o maxwell.o maxwell.c -std=c++17 -g #look up c version

echo "Link the three object files already created"
g++ -m64 -no-pie -o power.out isfloat.o maxwell.o hertz.o -std=c++17 -g #look up version
